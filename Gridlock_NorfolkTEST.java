 ...
 */
public class Gridlock_NorfolkTEST extends SimState
{
    ...
    /** Constructor */
    public Gridlock_NorfolkTEST(long seed)
    {
        super(seed);
    }
    ...
    public void start()
    {
        ...
        try
        {
            ...
            URL roadsFile = Gridlock_NorfolkTEST.class.getResource("data/roads.shp");
            ...
            URL areasFile = Gridlock_NorfolkTEST.class.getResource("data/areas.shp");
            ...
            populate("/Users/KJGarbutt/Copy/workspace/EngDProject/src/sim/app/geo/gridlock_norfolk_TEST/data/NorfolkITNLSOA.csv");
            agents.setMBR(MBR);
            ...
            Steppable flipper = new Steppable()
            {
                ...
                public void step(SimState state)
                {
                    ...
                    Gridlock_NorfolkTEST gstate = (Gridlock_NorfolkTEST) state;
    ...
    public void populate(String filename)	{
    	...
    	try	{
            ...
            String filePath = Gridlock_NorfolkTEST.class.getResource(filename).getPath();
            ...
            while ((s = d.readLine()) != null)	{ 
                ...
                // column 'M' TRACTTOTRA
                Integer pop = Integer.parseInt(bits[23]); // TODO: reset me if desired!
                
                // column 'F' SCTRACTW?
                //String workTract = bits[5];
                // column 'W' SCTRACTW
                String workTract = bits[24];
    ...
    {
        doLoop(Gridlock_NorfolkTEST.class, args);
        System.exit(0);
    }
