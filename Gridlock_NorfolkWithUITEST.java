...
public class Gridlock_NorfolkWithUITEST extends GUIState
{
    ...
    protected Gridlock_NorfolkWithUITEST(SimState state)
    {
        super(state);
    }
    ...
    {
        Gridlock_NorfolkWithUITEST simple = new Gridlock_NorfolkWithUITEST(new Gridlock_NorfolkTEST(System.currentTimeMillis()));
    ...
    public void start()
    {
        ...
        Gridlock_NorfolkTEST world = (Gridlock_NorfolkTEST) state;
